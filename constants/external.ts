export const alertText = [
    {
        label: 'Unlock your flow state with a better developer experience.',
        action: 'Grab tickets now to GitHub Universe on Oct. 29-30.',
        href: 'http://www.google.ca'
    }
]

export const navLinks = [
    {label: 'Product', icon:'/home.png', href:"/dashboard"},
    {label: 'Solutions', icon:'/home.png', href:"/dashboard"},
    {label: 'Resources', icon:'/home.png', href:"/dashboard"},
    {label: 'Open Source', icon:'/home.png', href:"/dashboard"},
